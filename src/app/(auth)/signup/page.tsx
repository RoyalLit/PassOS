    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border p-8 text-center">
          ...
          <p className="text-slate-500 mt-2">You can now sign in with your credentials.</p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border p-8">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-slate-900">Join PassOS</h1>
          <p className="text-slate-500 mt-2">Smart Gate Pass Management</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition-shadow"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-4">I am a...</label>
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                >
                  <role.icon className={clsx("w-5 h-5", formData.role === role.id ? "text-blue-600" : "text-slate-400")} />
                  {role.label}
                </button>
              ))}
            </div>
          ...
          <div className="pt-4 flex flex-col gap-4">
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-4 py-3 font-bold transition-all shadow-lg shadow-blue-100 disabled:opacity-50"
            >
